...
// +-------------------------------------------------+
// $Id: fichier.php,v 1.8.6.4 2021/02/12 22:33:53 dgoron Exp $
...
switch($dest) {
	...
	default:
		...
		print str_replace('!!menu_contextuel!!', module_fichier::get_instance()->get_display_subtabs(), $fichier_layout);
		break;
}
