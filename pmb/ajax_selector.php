...
// +-------------------------------------------------+
// $Id: ajax_selector.php,v 1.123.2.10 2021/03/22 14:08:26 dgoron Exp $
...
switch($completion):
	...
	case 'categories_mul':
		...
		$requete="select * from (".$requete_langue." union ".$requete_defaut.") as sub1 group by categ_id order by pert desc,num_thesaurus, index_categorie";
