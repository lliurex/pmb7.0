...
// +-------------------------------------------------+
// $Id: notice.class.php,v 1.317.2.16 2021/03/19 08:54:04 dgoron Exp $
		...
		protected function get_tab_customs_perso_form_convo() {
			...
			if (!$p_perso->no_special_fields) {
				...
				for ($i=0; $i<count($perso_["FIELDS"]); $i++) {
					...
					$c6='Ubicac';
					if (strncmp($p["NAME"], $c1,6)== 0) {
						$perso.="<div id='move_".$p["NAME"]."' movable='yes' title=\"".htmlentities($msg["notice_convo_type_id"],ENT_QUOTES, $charset)."\">
						...
						if (strncmp($p["NAME"], $c2,6)== 0) {
							$perso.="<div id='move_".$p["NAME"]."' movable='yes' title=\"".htmlentities($msg["notice_convo_langue"],ENT_QUOTES, $charset)."\">
							...
							if (strncmp($p["NAME"], $c3,6)== 0) {
								$perso.="<div id='move_".$p["NAME"]."' movable='yes' title=\"".htmlentities($msg["notice_convo_authorship"],ENT_QUOTES, $charset)."\">
								...
								if (strncmp($p["NAME"], $c4,6)== 0) {
									$perso.="<div id='move_".$p["NAME"]."' movable='yes' title=\"".htmlentities($msg["notice_convo_literary_work"],ENT_QUOTES, $charset)."\">
									...
									if (strncmp($p["NAME"], $c5,6)== 0) {
										$perso.="<div id='move_".$p["NAME"]."' movable='yes' title=\"".htmlentities($msg["notice_convo_price"],ENT_QUOTES, $charset)."\">
										...
										if (strncmp($p["NAME"], $c6,6)== 0) {
											$perso.="<div id='move_".$p["NAME"]."' movable='yes' title=\"".htmlentities($msg["notice_convo_location"],ENT_QUOTES, $charset)."\">
