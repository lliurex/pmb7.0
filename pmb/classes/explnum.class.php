...
// +-------------------------------------------------+
// $Id: explnum.class.php,v 1.119.2.10 2021/04/06 09:00:00 gneveu Exp $
...
if (! defined('EXPLNUM_CLASS')) {
	...
	//--------------------------------------------------------FIN LLIUREX CONVOCATORIA------------------------------					
		...
		public function get_file_from_temp($filename, $name, $upload_place, $integrator_docnum = false) {
			global $base_path;
			global $ck_index;
			global $id_rep, $up_place;
