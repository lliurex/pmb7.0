...
// +-------------------------------------------------+
// $Id: serials.class.php,v 1.240.2.15 2021/03/31 15:50:37 dgoron Exp $
...
class bulletinage extends notice {
	...
	public function do_form() {
		...
		if($this->bulletin_id) {
			...
			$link_annul = serial::get_permalink($this->get_serial()->id);
...
//----------------- INICIO LLIUREX -----------------------------
//		$analysis_top_form = str_replace('!!tab999!!', $this->get_tab_customs_perso_form_convo(), $analysis_top_form);
//------------------ FIN LLIUREX ------------------------------
		...
		$analysis_top_form = str_replace('!!tab13!!', $notice_relations->get_form($this->notice_link, 'a', ($this->duplicate_from_id ? true : false)),$analysis_top_form);
