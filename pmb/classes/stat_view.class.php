...
// +-------------------------------------------------+
// $Id: stat_view.class.php,v 1.24.2.2 2021/04/07 07:21:01 dgoron Exp $
...
class stat_view {
	...
	public function do_form(){
		...
		if(pmb_mysql_num_rows($res) == 0){			
			...
			$stat_opac_view_form=str_replace("!!remove_data_interval_date_deb!!",$btn_remove_data_interval_date_deb,$stat_opac_view_form);
			$stat_opac_view_form=str_replace("!!remove_data_interval_date_fin!!",$btn_remove_data_interval_date_fin,$stat_opac_view_form);
