...
// +-------------------------------------------------+
// $Id: netbase.class.php,v 1.15.6.3 2021/03/16 16:21:21 moble Exp $
...
class netbase {
	...
	public function get_form_proceedings($proceedings=array()) {
		...
		//-----------LLIUREX--------------
		//Changed to checked: index_global,index_notices
		//---------LLIUREX------------------
		// R�indexer
		$form_proceedings = "
		...
		//-----------------LLIUREX------------------
		//Changed to checked: index_authorities
		//----------------LLIUREX----------------
		$form_proceedings .= "
			<div class='row'>
				<input type='checkbox' value='268435456' id='index_authorities' name='index_authorities' ".(isset($index_authorities) && $index_authorities == "268435456" ? "checked" :"checked").">&nbsp;<label for='index_authorities'>".htmlentities($msg["nettoyage_index_authorities"], ENT_QUOTES, $charset)."</label>
			</div>";
		...
		//-------------LLIUREX-------------
		//Changed to checked:gen_phonetique
		//------------LLIUREX--------------
		// G�n�rer
		$form_proceedings .= "
			<br />
