...
// +-------------------------------------------------+
// $Id: contribution_area_param.class.php,v 1.3.6.3 2020/11/05 09:55:13 gneveu Exp $
...
class contribution_area_param {
	...
	public function save_from_form(){
	    global $source_url, $user_name, $user_password, $show_sub_form, $accordion_result, $auto_save_draft, $contribution_edit_entity;
