...
// +-------------------------------------------------+
// $Id: list_users_ui.class.php,v 1.1.2.9 2021/02/18 14:11:20 gneveu Exp $
...
class list_users_ui extends list_ui {
	...
	protected function get_display_cell($object, $property) {
		$attributes = array(
				'onclick' => "window.location=\"".static::get_controller_url_base()."&action=view&suite=acces&id_rss_flux=".$object->id_rss_flux."\""
		);
