...
// +-------------------------------------------------+
// $Id: list_configuration_empr_statut_ui.class.php,v 1.1.6.3 2021/01/12 07:30:11 dgoron Exp $
...
class list_configuration_empr_statut_ui extends list_configuration_empr_ui {
	...
	protected function get_main_fields_from_sub() {
		return array(
				...
				'allow_pnb' => 'empr_short_no_allow_pnb',
		);
	}
