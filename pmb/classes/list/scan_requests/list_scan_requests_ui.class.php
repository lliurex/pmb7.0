...
// +-------------------------------------------------+
// $Id: list_scan_requests_ui.class.php,v 1.2.2.12 2021/03/26 10:08:34 dgoron Exp $
...
class list_scan_requests_ui extends list_ui {
	...
	protected function _compare_objects($a, $b) {
		...
		switch ($sort_by) {
			case 'creator_name':
				...
				return strcmp(pmb_strtolower($content_a), pmb_strtolower($content_b));
				break;
			default:
	...
	protected function get_title() {
		global $msg, $charset;
		return "<h1>".htmlentities($msg["scan_request_list"], ENT_QUOTES, $charset)."</h1>";
	}
