...
// +-------------------------------------------------+
// $Id: list_transferts_ui.class.php,v 1.2.4.20 2021/03/26 10:08:34 dgoron Exp $
...
class list_transferts_ui extends list_ui {
	...
	protected function get_search_filter_site_origine() {
		$selector = "<select name='".$this->objects_type."_site_origine'>";
		$selector .= $this->get_search_options_locations($this->filters['site_origine']);
		$selector .= "</select>";
		return $selector;
	}
	
	protected function get_search_filter_site_destination() {
		$selector = "<select name='".$this->objects_type."_site_destination'>";
		$selector .= $this->get_search_options_locations($this->filters['site_destination']);
		$selector .= "</select>";
		return $selector;
	}
