...
// +-------------------------------------------------+
// $Id: cms_editorial_types.class.php,v 1.20.4.3 2021/01/05 15:29:26 dgoron Exp $
...
class cms_editorial_types {
	...
	public function get_table($form_link=""){
		...
		for($i=0 ; $i<count($types) ; $i++){
			...
			$table.= "<td onclick='document.location=\"".$form_link."&id=".$types[$i]['id']."\"'style='cursor:pointer' >".nl2br(htmlentities($types[$i]['comment'],ENT_QUOTES,$charset))."</td>
