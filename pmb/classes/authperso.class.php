...
// +-------------------------------------------------+
// $Id: authperso.class.php,v 1.94.2.8 2021/02/01 14:09:07 qvarin Exp $
...
class authperso {
	...
	public function get_form($id, $duplicate = false) {
		...
		if ($this->is_responsability_authperso()) {
		    $authperso_form = str_replace('<!-- rep_aut_link -->', $this->gen_template_responsability($id), $authperso_form);
		}
		// Indexation concept
