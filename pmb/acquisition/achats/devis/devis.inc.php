...
// +-------------------------------------------------+
// $Id: devis.inc.php,v 1.56.2.2 2020/08/31 12:42:55 dbellamy Exp $

if (stristr($_SERVER['REQUEST_URI'], ".inc.php")) die("no access");

global $id, $id_dev, $id_exer, $id_bibli, $class_path, $include_path, $base_path, $msg, $charset, $action, $chk, $sugchk, $by_mail;
