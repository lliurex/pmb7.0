...
// +-------------------------------------------------+
// $Id: alter_vLlxPandora.inc.php, migración BD a v5.33 (Lliurex 21 Focal desde v.5.10 (Lliurex 14.05 Trusty)
...
//  case "v5.10":
//-------------------LLIUREX 66/03/2021----------
		// 24 actualizaciones desde pandora (v5.10) a focal (v5.33)
