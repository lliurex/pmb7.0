...
// +-------------------------------------------------+
// $Id: alter_vLlxTrusty.inc.php, migración BD a v5.33 (Lliurex 21 Focal desde v.5.14 (Lliurex 15.05 Trusty)
...
//	case "v5.14": 
//---------------------LLIUREX 16/03/2021-------------------------	
		// 20 actualizaciones desde trusty (v5.14) a focal (v5.33)
		$increment=100/20;
