...
// +-------------------------------------------------+
// $Id: Notice.php,v 1.6.2.1 2020/03/12 16:04:34 arenou Exp $
...
class Notice extends Collection {
    ...
    public function getLastModified() {
    	$query = 'select unix_timestamp(update_date) as update_date from notices where notice_id = '.$this->notice_id;
    	$result = pmb_mysql_query($query);
    	if (pmb_mysql_num_rows($result)) {
    		$row = pmb_mysql_fetch_object($result);
