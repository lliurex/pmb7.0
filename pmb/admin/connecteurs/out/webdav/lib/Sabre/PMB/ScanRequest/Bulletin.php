...
// +-------------------------------------------------+
// $Id: Bulletin.php,v 1.6.2.1 2020/03/12 16:04:34 arenou Exp $
...
class Bulletin extends Collection {
    ...
    public function getLastModified() {
    	$query = 'select unix_timestamp(date_date) as date_date from bulletins where bulletin_id = '.$this->bulletin_id;
    	$result = pmb_mysql_query($query);
    	if (pmb_mysql_num_rows($result)) {
    		$row = pmb_mysql_fetch_object($result);
