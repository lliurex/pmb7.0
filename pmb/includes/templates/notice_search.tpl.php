...
// +-------------------------------------------------+
// $Id: notice_search.tpl.php,v 1.27.6.1 2021/03/11 14:14:00 moble Exp $
...
$menu_search_commun="
<div class='hmenu'>
	<span".ongletSelect("categ=search&mode=0")." id='notice_search_tab_0'>
		<a href='./catalog.php?categ=search&mode=0'>
			$msg[354]
		</a>
	</span>
	<span".ongletSelect("categ=search&mode=1")." id='notice_search_tab_1'>
		<a href='./catalog.php?categ=search&mode=1'>
			$msg[355]
		</a>
	</span>
	<span".ongletSelect("categ=search&mode=5")." id='notice_search_tab_5'>
		<a href='./catalog.php?categ=search&mode=5'>
			".$msg['search_by_terms']."
		</a>
	</span>
	<span".ongletSelect("categ=search&mode=2")." id='notice_search_tab_2'>
		<a href='./catalog.php?categ=search&mode=2'>
			$msg[356]
		</a>
	</span>";
if ($pmb_use_uniform_title)	$menu_search_commun.="<span".ongletSelect("categ=search&mode=9")." id='notice_search_tab_9'>
...
$menu_search_commun.="
	<!-- !!authpersos!! -->
	<span".ongletSelect("categ=search&mode=3")." id='notice_search_tab_3'>
		<a href='./catalog.php?categ=search&mode=3'>
			".$msg['search_by_panier']."
		</a>
	</span>
	<span".ongletSelect("categ=search&mode=6")." id='notice_search_tab_6'>
		<a href='./catalog.php?categ=search&mode=6'>
			".$msg['search_extended']."
		</a>
	</span>
	<span".ongletSelect("categ=search&mode=8")." id='notice_search_tab_8'>
...
if ($pmb_map_activate) $menu_search_commun.="<span".ongletSelect("categ=search&mode=11")." id='notice_search_tab_11'>
...
if ($pmb_allow_external_search) $menu_search_commun .= "
	<span".ongletSelect("categ=search&mode=7&external_type=simple")." id='notice_search_tab_7'>
