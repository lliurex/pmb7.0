...
// +-------------------------------------------------+
// $Id: demandes.tpl.php,v 1.35.2.2 2020/11/16 13:59:35 dgoron Exp $

if (stristr($_SERVER['REQUEST_URI'], ".tpl.php")) die("no access");

global $demandes_menu, $msg, $demandes_layout, $current_module, $demandes_layout_end, $form_filtre_demande, $current_module, $pmb_lecteurs_localises, $form_liste_demande;
...
$module_demandes = module_demandes::get_instance();
$demandes_menu = $module_demandes->get_left_menu();
