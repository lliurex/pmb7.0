...
// +-------------------------------------------------+
// $Id: list_ui.tpl.php,v 1.23.2.14 2021/01/05 13:12:52 dgoron Exp $
...
global $list_ui_settings_display_content_form_tpl, $list_ui_settings_columns_content_form_tpl, $list_ui_settings_filters_content_form_tpl;
	...
	<div class='form-contenu'>
		...
		<div class='row'>
			<div class='left'>
				...
				<input type='submit' id='!!objects_type!!_button_search' class='bouton' value='".$msg['apply']."' />&nbsp;
				!!list_button_save!!
