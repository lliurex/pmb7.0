...
// +-------------------------------------------------+
// $Id: dsi.tpl.php,v 1.95.2.10 2021/03/15 11:07:56 dgoron Exp $
...
global $dsi_menu, $dsi_layout, $dsi_desc_field, $dsi_desc_first_desc;
...
$module_dsi = module_dsi::get_instance();
$dsi_menu = $module_dsi->get_left_menu();
