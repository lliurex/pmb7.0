...
// +-------------------------------------------------+
// $Id: pmbesOPACEmpr.class.php,v 1.45.2.15 2021/03/17 07:42:39 dbellamy Exp $
...
class pmbesOPACEmpr extends external_services_api_class{
	...
	public function check_auth_aes($empr_login, $empr_password, $iv, &$empr_id) {
		...
		//Authentification normale
		$check_password = password::gen_hash($clear_empr_password,$verif_id_empr);		
	...
	public function change_password($session_id, $old_password, $new_password) {
		...
		$check_old_password = emprunteur::get_hashed_password($empr->login, $old_password);
		if ($check_old_password != $empr->pwd) {
			return 0;
		}
		//Changement
