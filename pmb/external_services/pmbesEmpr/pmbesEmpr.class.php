...
// +-------------------------------------------------+
// $Id: pmbesEmpr.class.php,v 1.27.2.7 2020/11/26 10:31:35 dbellamy Exp $

if (stristr($_SERVER['REQUEST_URI'], ".class.php")) die("no access");

global $base_path, $include_path, $class_path;
global $lang, $msg, $charset;
global $pmb_num_carte_auto, $pmb_gestion_abonnement, $pmb_gestion_financiere, $opac_websubscribe_password_regexp;
...
class pmbesEmpr extends external_services_api_class {
	...
	public function update_empr($empr_cb='', $empr_id=0, $fields) {
		...
		global $lang;
		global $msg;
		global $pmb_gestion_abonnement, $pmb_gestion_financiere, $opac_websubscribe_password_regexp;
