...
// +-------------------------------------------------+
// $Id: searcher.class.php,v 1.109.2.8 2020/11/05 10:45:48 btafforeau Exp $
...
//     }
    ...
    public function get_result(){
        ...
        if($cache_result===false){
            ...
            $rqt = "create temporary table ".$this->table." engine=memory select rid as notice_id from external_count where rid in(".$this->notices_ids.")";
            $res = pmb_mysql_query($rqt);
