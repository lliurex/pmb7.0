...
// +-------------------------------------------------+
// $Id: searcher_sphinx.class.php,v 1.10.6.2 2020/10/30 11:36:55 btafforeau Exp $
...
class searcher_sphinx {
	...
	public function __construct($user_query){
	    ...
	    $this->sphinx_query = analyse_query::get_sphinx_query(stripslashes($this->user_query));
