...
// +-------------------------------------------------+
// $Id: onto_contribution_datatype_docnum_file_ui.class.php,v 1.2.8.1 2021/04/06 09:00:00 gneveu Exp $
...
class onto_contribution_datatype_docnum_file_ui extends onto_common_datatype_file_ui {
	...
	{
	    $id_directory = onto_common_datatype::get_properties_from_uri($item_uri)['upload_directory'];
	    if (!$id_directory) return '';
