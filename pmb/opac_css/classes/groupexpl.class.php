...
// +-------------------------------------------------+
// $Id: groupexpl.class.php,v 1.7.2.1 2021/02/02 12:35:32 dgoron Exp $
...
class groupexpl {
	...
	public function get_form() {
		...
		if($this->id){
			...
			$tpl=str_replace('!!delete!!',"<input type='button' class='bouton' value='".$msg['63']."'  onclick=\"document.getElementById('action').value='delete';this.form.submit();\"  />", $tpl);
