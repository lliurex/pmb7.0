...
// +-------------------------------------------------+
// $Id: change_password.inc.php,v 1.18.6.3 2020/03/04 08:38:45 dgoron Exp $
...
switch ($action) {
    case "save":
        ...
        if (($password_key) || ($emprunteur->pwd == emprunteur::get_hashed_password($empr_login, $old_password))) {
