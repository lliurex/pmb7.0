...
// +-------------------------------------------------+
// $Id: cms_module_agenda_view_calendar_django.class.php,v 1.10.6.7 2021/03/10 09:23:09 qvarin Exp $
...
{% endfor %}
	...
	public function render($datas){
		...
		$json_events = encoding_normalize::json_encode($this->utf8_encode($events));
