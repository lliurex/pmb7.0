...
// +--------------------------------------------------------------------------+
// $Id: print.php,v 1.120.4.9 2021/03/16 08:48:17 jlaurent Exp $
...
if ($action!="print_$lvl") {
	...
	$output_final.= "<form name='print_options' id='print_options' action='print.php?lvl=" . urlencode($lvl) . "&action=print_" . urlencode($lvl) . ($mode ? "&mode=".$mode : '') . "' method='post'>";
